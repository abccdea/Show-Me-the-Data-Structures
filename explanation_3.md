A dictionary was used to store the letters and their frequencies as key and values. Also an array was used to just store the keys in the sorted order since sorting is easy in arrays.
